...
const DATA = {
  ...
  listening: [
    ...
    {
      id: "animals_listen",
      title: "Let's Talk About Animals!",
      speech: "Dana says: Tom, let us talk about animals! Tom says: OK! I love animals. Dana says: Tell me about elephants. Tom says: Elephants are big. They have big ears and a long nose. They play in the water. Dana says: What about turtles? Tom says: Turtles are slow. They have a funny face. They can swim and walk. Dana says: And zebras? Tom says: Zebras are beautiful. They are black and white. Dana says: I love zebras! Tom says: Me too!",
      questions: [
        { q: "What do elephants have?",                options: ["Small ears and a short nose", "Big ears and a long nose", "A funny face and big teeth"], answer: 1 },
        { q: "What do elephants do in the water?",     options: ["Sleep", "Play", "Walk slowly"],                            answer: 1 },
        { q: "How do turtles move?",                   options: ["Very fast", "Very slow", "They cannot move"],              answer: 1 },
        { q: "What can turtles do?",                   options: ["Fly and sing", "Swim and walk", "Run and jump"],           answer: 1 },
        { q: "What color are zebras?",                 options: ["Brown and yellow", "Black and white", "Orange and black"], answer: 1 },
      ],
    },
    {
      id: "routine_listen",
      title: "Lisa's Day",
      speech: "Amy says: Lisa, what time do you wake up? Lisa says: I wake up at half past six. Amy says: That is early! Lisa says: Yes. I eat breakfast at seven o'clock. Amy says: And what time do you go to school? Lisa says: I go to school at half past eight. Amy says: When do you eat dinner? Lisa says: I eat dinner at six o'clock. Amy says: And when do you go to sleep? Lisa says: I go to sleep at half past nine. Amy says: Me too!",
      questions: [
        { q: "What time does Lisa wake up?",           options: ["Six o'clock", "Half past six", "Seven o'clock"],           answer: 1 },
        { q: "What does Lisa do at seven o'clock?",    options: ["Go to school", "Eat breakfast", "Go to sleep"],            answer: 1 },
        { q: "What time does Lisa go to school?",      options: ["Seven o'clock", "Half past seven", "Half past eight"],     answer: 2 },
        { q: "What time does Lisa eat dinner?",        options: ["Half past five", "Six o'clock", "Half past six"],          answer: 1 },
    ...
    },
    {
      ...
      speech: "Sara says: Tom, what languages can you speak? Tom says: I can speak Hebrew and English. Sara says: Can you speak Arabic? Tom says: A little. I am good at English. Sara says: I am good at Hebrew. I have a test in Hebrew today. Tom says: Good luck! Sara says: Thank you. Do you know Arabic letters? Tom says: No, I do not know Arabic letters. But I want to try! Sara says: Good idea!",
      questions: [
        { q: "What languages can Tom speak?",          options: ["English and Arabic", "Hebrew and English", "Arabic and Hebrew"], answer: 1 },
        { q: "What is Tom good at?",                   options: ["Hebrew", "Arabic", "English"],                              answer: 2 },
        { q: "What is Sara good at?",                  options: ["English", "Hebrew", "Arabic"],                              answer: 1 },
        { q: "What does Sara have today?",             options: ["A birthday party", "A test in Hebrew", "An English lesson"], answer: 1 },
        { q: "Does Tom know Arabic letters?",          options: ["Yes, he knows them well", "No, but he wants to try", "Yes, a little"], answer: 1 },
      ],
    },
  ],
